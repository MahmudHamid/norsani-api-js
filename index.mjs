...
export default class NorsaniRestApi {
   ...
   */
  constructor(opt) {
    if (!(this instanceof NorsaniRestApi)) {
      return new NorsaniRestApi(opt);
    }
   ...
   * @return {Object}
   */
  _request(method, endpoint, requestapi, data, params = {}) {
    const url = this._getUrl(endpoint, requestapi, params);
   ...
   * @return {Object}
   */
  get(endpoint, requestapi, params = {}) {
    return this._request("get", endpoint, requestapi, null, params);
  }
   ...
   * @return {Object}
   */
  post(endpoint, requestapi, data, params = {}) {
    return this._request("post", endpoint, requestapi, data, params);
  }
   ...
   * @return {Object}
   */
  put(endpoint, requestapi, data, params = {}) {
    return this._request("put", endpoint, requestapi, data, params);
  }
   ...
   * @return {Object}
   */
  delete(endpoint, requestapi, params = {}) {
    return this._request("delete", endpoint, requestapi, null, params);
  }
   ...
   * @return {Object}
   */
  options(endpoint, requestapi, params = {}) {
    return this._request("options", endpoint, requestapi, null, params);
  }
}
